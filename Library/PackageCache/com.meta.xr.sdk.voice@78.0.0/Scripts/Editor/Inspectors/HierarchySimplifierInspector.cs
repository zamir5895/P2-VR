...
namespace Oculus.Voice.UX
{
    ...
    public class HierarchySimplifierInspector : Editor
    {
        ...
        private const string MenuPath = "Meta/Voice SDK/Show all advanced game objects";
        ...
        {
            foreach (var obj in FindObjectsByType<HierarchySimplifier>(FindObjectsSortMode.None))
            {
