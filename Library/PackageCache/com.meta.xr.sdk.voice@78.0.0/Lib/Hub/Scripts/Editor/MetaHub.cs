        ...
        public string SelectedPage
        {
            ...
            set
            {
                if (_selectedPageId != value)
                {
                    ...
                    Telemetry.Editor.LogInstantEvent(EditorTelemetry.TelemetryEventId.OpenUi,
                        new Dictionary<EditorTelemetry.AnnotationKey, string>()
                        {
                            { EditorTelemetry.AnnotationKey.PageId, _selectedPageId }
                        });
