...
namespace Meta.WitAi.Composer
{
    ...
    public class ComposerEvents
    {
        ...
        /// <summary>
        /// Callback prior request parameter setup
        /// </summary>
        public ComposerSessionRequestEvent OnComposerRequestCreated;
        /// <summary>
        /// Callback following request parameter setup
        /// </summary>
    ...
    /// <summary>
    /// An event that includes session data and a specific voice service request
    /// </summary>
    [Serializable]
